    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      >
        <div className="flex w-[min(100%,520px)] flex-col rounded border border-[rgba(24,23,21,0.14)] bg-[linear-gradient(90deg,rgba(246,244,237,0.96),rgba(246,244,237,0.82)),linear-gradient(180deg,rgba(127,36,49,0.08),transparent_44%)] px-8 py-[30px] shadow-[0_24px_72px_rgba(24,23,21,0.18)] backdrop-blur-[14px] max-[760px]:h-[33svh] max-[760px]:min-h-[220px] max-[760px]:w-full max-[760px]:justify-between max-[760px]:overflow-hidden max-[760px]:px-5 max-[760px]:py-[18px]">
          <div>
            <h1 className="m-0 max-w-[10ch] font-serif text-[clamp(4rem,9vw,7rem)] leading-[0.88] font-medium max-[760px]:text-[clamp(2.9rem,13vw,3.75rem)]">
              Eric Krenz
            </h1>
            <p className="mt-[18px] max-w-[30rem] text-[0.88rem] leading-[1.55] font-bold tracking-[0.08em] text-(--text) uppercase max-[760px]:mt-2.5 max-[760px]:text-[0.7rem] max-[760px]:leading-[1.38]">
              Software Engineer, World Traveller, Amateur Sommelier
            </p>
          </div>
          <div
            className="my-0 mt-[26px] mb-[22px] h-[3px] w-[86px] bg-(--accent) max-[760px]:mt-0 max-[760px]:mb-0 max-[760px]:h-0.5 max-[760px]:w-[72px]"
            aria-hidden="true"
          />
          <div>
            <p className="mb-2.5 text-[0.78rem] font-bold tracking-[0.12em] text-(--accent) uppercase max-[760px]:mb-1.5 max-[760px]:text-[0.68rem]">
              Featured place
            </p>
            <h2 className="m-0 max-w-[14ch] font-serif text-[clamp(2rem,4vw,3.25rem)] leading-[0.96] font-medium max-[760px]:text-[clamp(1.45rem,6vw,2rem)]">
              {scene.title}
            </h2>
            <p className="mt-2.5 max-w-[30rem] text-[clamp(1.05rem,1.8vw,1.35rem)] leading-[1.35] text-(--muted) max-[760px]:mt-1.5 max-[760px]:text-[0.94rem] max-[760px]:leading-[1.3]">
              {scene.subtitle}
            </p>
          </div>
        </div>
